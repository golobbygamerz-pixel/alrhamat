        ...
        <main>
          <section className="hero">
            ...
            <div className="container hero-content">
              ...
              >
                ...
                <h1>A refined stay, designed around you.</h1>
                <p>
                  Thoughtful rooms, warm Indian hospitality and a
                ...
                <div className="hero-actions">
                  ...
                  <Link className="button button-light-outline" to="/rooms">
                    Explore rooms
                  </Link>
                </div>
              </motion.div>
          ...
          <section className="section section-ivory">
            <div className="container split-section">
              <div>
                <span className="eyebrow">THE AL RAHAMAT EXPERIENCE</span>
                <h2>Hospitality with a quieter point of view.</h2>
                <p className="lead">
                  Every detail is designed to make your stay feel
                  comfortable, considered and effortless.
                </p>
          ...
          <section className="section">
            <div className="container">
              ...
              />
              <FacilityGrid facilities={facilities.slice(0, 6)} />
            </div>
          </section>
...
export function RoomDetails() {
  ...
  const room = rooms.find(
    (item) => item.id === roomId || item.slug === roomId
  );
  const navigate = useNavigate();
  if (!room) {
    return (
            ...
            <div className="container">
              ...
              <div className="room-detail-grid">
                ...
                <aside className="booking-card">
                  ...
                  <p>
                    Taxes and payment options are shown during
                    booking.
                  </p>
                  <Button
                    full
        ...
        <main>
          ...
          <section className="section">
            <div className="container narrow-container">
              <BookingSearchBar
                initialValue={getBookingSearch() ?? undefined}
...
export function AvailableRooms() {
  ...
  const [search, setSearch] = useState<BookingSearch | null>(
    getBookingSearch()
  );
  ...
  useEffect(() => {
    ...
    if (checkIn && checkOut) {
      const fallback: BookingSearch = {
        ...
        bedType:
          (searchParams.get("bedType") as BedType) || "King Bed",
      };
  ...
  const handleSearch = (nextSearch: BookingSearch) => {
  ...
  const matchingResults = useMemo(() => {
    ...
    return results.filter(
      (room) =>
        room.available_units >= search.rooms &&
        room.max_guests >= totalGuests &&
        room.bed_type === search.bedType
    );
  }, [results, search]);
  return (
    <SiteShell>
        ...
        <main>
          <section className="page-hero compact">
            <div className="container">
              ...
              <PageTitle
                ...
                text={
                  search
                    ? `${search.adults} adults · ${search.children} children · ${search.rooms} room${search.rooms > 1 ? "s" : ""}`
          ...
          <section className="availability-results section">
            <div className="container">
              ...
              {loading && <LoadingState text="Checking live availability..." />}
              {!loading && error && (
                <ErrorState
              ...
              {!loading && !error && matchingResults.length > 0 && (
                <div className="available-room-list">
                  {matchingResults.map((room) => (
                    <motion.article
                      key={room.room_id}
            ...
            <div className="container booking-layout">
              ...
              >
                ...
                <p className="secure-note">
                  <ShieldCheck size={16} />
                  Your reservation is protected by our secure booking
                  system.
                </p>
              </form>
              <BookingSummary
        ...
        <main className="success-page">
          <div className="container narrow-container">
            ...
            >
              ...
              <p>
                Thank you, {booking.guest_first_name}. Your reservation
...
export function MyBooking() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    if (!bookingCode.trim() || !phone.trim()) {
      setError("Please enter your booking ID and phone number.");
      return;
    }
    setLoading(true);
    try {
    ...
    <SiteShell>
      <PageTransition>
        <main>
          <section className="page-hero">
            <div className="container">
              <Breadcrumb items={[{ label: "My Booking" }]} />
              <PageTitle
            ...
            <div className="container narrow-container">
              ...
              >
                ...
                <Button
                  ...
                  disabled={loading}
                >
                  {loading ? "Finding booking..." : "Find booking"}
                </Button>
              </form>
              {booking && (
                <motion.div
                ...
                >
                  ...
                  <div className="booking-result-grid">
                    ...
                    <div>
                      <span>Rooms</span>
                      <strong>{booking.rooms_count}</strong>
                    </div>
                    <div>
                      <span>Bed</span>
                      <strong>{booking.bed_type}</strong>
                    </div>
                    <div>
                      <span>Payment</span>
                      <strong>
        ...
        <main>
          <section className="cinematic-section">
            ...
            <div className="container cinematic-content">
              ...
              <h1>Stay a little slower.</h1>
              <p>
                Warm hospitality, considered spaces and room to
                breathe.
              </p>
            </div>
          </section>
          <section className="section">
            <div className="container split-section">
              <div>
                ...
                <h2>Feel at home, without being at home.</h2>
                <p className="lead">
                  From the moment you arrive, our focus is simple:
                  make your stay comfortable and uncomplicated.
                </p>
              </div>
              <div className="experience-copy">
                <p>
                  Whether you are travelling for work, visiting family
                  or taking a break, Al Rahamat Hotel is designed to
                  give you a calm base for your journey.
                </p>
                <p>
                  Thoughtful rooms, practical facilities and warm
                  service come together without unnecessary fuss.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="container">
              ...
              <div className="three-column">
                <div className="value-card">
                  <Sparkles size={24} />
                  <h3>Considered spaces</h3>
                  <p>
                    Rooms designed to feel polished, comfortable and
                    easy to settle into.
                  </p>
                </div>
                <div className="value-card">
                  ...
                  <p>
                    Personal service with the warmth of Indian
                    hospitality.
                  </p>
                </div>
                <div className="value-card">
                  ...
                  <h3>Easy stays</h3>
                  <p>
                    Straightforward booking, clear information and
          ...
          <section className="section">
            <div className="container split-section">
              ...
              <div>
                ...
                <p className="lead">
                  Al Rahamat Hotel brings together modern comfort and
                  the warmth of Indian hospitality.
                </p>
                <p>
                  We believe a good hotel stay should feel easy. From
                  a comfortable room to clear communication and
                  thoughtful service, every part of the experience
                  should help you feel settled.
                </p>
                <p>
                  Whether you are staying for one night or several,
                  our aim is to make Al Rahamat feel like a dependable
          ...
          <section className="section">
            <div className="container contact-layout">
              ...
              <div className="contact-card">
                ...
                <p>
                  For booking questions, room requests or general
                  enquiries, contact our team directly.
                </p>
            ...
            <div className="container">
              ...
              <div className="three-column">
                ...
                <div className="value-card">
                  ...
                  <p>
                    Contact us if you need help with an existing
                    reservation.
                  </p>
                </div>
              </div>
